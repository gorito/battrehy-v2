            ...
            <div className="max-w-3xl mx-auto">
                ...
                <article>
                    ...
                    <div className="text-lg text-gray-700 leading-relaxed space-y-6">
                        ...
                        <p>Aktiv akne behöver två saker: minskning av bakterier och kontroll av talgproduktion. <strong>Djuprengörande ansiktsbehandling</strong> öppnar och rensar porerna. <strong>Kemisk peeling med BHA (salicylsyra)</strong> löser upp talg djupt nere i porerna. <strong>Blått LED-ljus</strong> dödar aknebakterier (P. acnes). Kombineras ofta som en serie över 4–8 veckor. Microneedling <strong>avråds vid aktiv inflammation</strong> men kan användas mot aknearr när huden är lugn. Läs mer i <Link href="/blogg/aknebehandling" className="text-primary hover:underline font-medium">vår kompletta guide till aknebehandling</Link>.</p>
