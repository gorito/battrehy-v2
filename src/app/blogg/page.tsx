        ...
        <main className="min-h-screen bg-gray-50 p-4 sm:p-8 pb-24">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {/* Article Card 11 */}
                    <Link href="/blogg/jamfor-behandlingar" className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-md transition-shadow group flex flex-col h-full">
                        <div className="h-48 bg-gray-100 relative overflow-hidden flex items-center justify-center border-b border-gray-100">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/images/blogg/jamfor-behandlingar-hero.webp" alt="Klient och behandlare diskuterar behandlingsalternativ vid en konsultation" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <h2 className="absolute bottom-4 left-6 text-2xl font-bold text-white z-10 drop-shadow-sm">Jämför behandlingar<br/><span className="text-sm font-medium opacity-90">Botox, filler, HIFU eller laser?</span></h2>
                        </div>
                        <div className="p-6 flex flex-col flex-grow">
                            <div className="text-xs text-primary font-bold tracking-wide uppercase mb-2">Guide</div>
                            <h2 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary transition-colors line-clamp-2">
                                Botox, filler, HIFU eller laser? Så väljer du rätt behandling – guide 2026
                            </h2>
                            <p className="text-gray-600 text-sm mb-6 line-clamp-3">
                                Vilken estetisk behandling passar dig? Jämför botox, filler, HIFU, laser, peeling och microneedling – vad de gör, återhämtningstid, hållbarhet och pris.
                            </p>
                            <div className="mt-auto flex items-center text-primary font-medium text-sm group-hover:underline">
                                Läs hela guiden <ArrowRight size={16} className="ml-1" />
                            </div>
                    ...
                    {/* Article Card 12 */}
                    <Link href="/blogg/rosacea" className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-md transition-shadow group flex flex-col h-full">
                        <div className="h-48 bg-gray-100 relative overflow-hidden flex items-center justify-center border-b border-gray-100">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/images/blogg/rosacea-hero.webp" alt="Person med naturlig, lätt ansiktsrodnad" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <h2 className="absolute bottom-4 left-6 text-2xl font-bold text-white z-10 drop-shadow-sm">Rosacea<br/><span className="text-sm font-medium opacity-90">Symtom, triggers & behandling</span></h2>
                        </div>
                        <div className="p-6 flex flex-col flex-grow">
                            <div className="text-xs text-primary font-bold tracking-wide uppercase mb-2">Guide</div>
                            <h2 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary transition-colors line-clamp-2">
                                Rosacea: symtom, triggers och behandlingar som hjälper – guide 2026
                            </h2>
                            <p className="text-gray-600 text-sm mb-6 line-clamp-3">
                                Vad är rosacea och vad hjälper mot rodnaden? Guide till symtom, triggers, skonsam hudvård, medicinsk behandling och IPL/laser – och när du bör söka läkare.
                            </p>
                            <div className="mt-auto flex items-center text-primary font-medium text-sm group-hover:underline">
                                Läs hela guiden <ArrowRight size={16} className="ml-1" />
                            </div>
