            ...
            <div className="max-w-3xl mx-auto">
                ...
                <article>
                    ...
                    <div className="text-lg text-gray-700 leading-relaxed space-y-6">
                        ...
                        <p>Priset för en estetisk behandling varierar kraftigt beroende på behandling, klinik och stad. Konsultationen är ofta kostnadsfri, eller så dras avgiften av om du sedan bokar en behandling. För prisspann på enskilda behandlingar – från ansiktsbehandlingar till injektioner – hänvisar vi till våra djupgående behandlingsguider, som <Link href="/blogg/ansiktsbehandling-den-kompletta-guiden" className="text-primary hover:underline">guiden till ansiktsbehandling</Link> och vår <Link href="/blogg/anti-aging-behandling" className="text-primary hover:underline font-medium">guide till anti-aging behandlingar</Link>.</p>
