                ...
                <article>
                    ...
                    <div className="text-lg text-gray-700 leading-relaxed space-y-6">
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li><strong>Pigmentfläckar och solskador</strong> – kan behandlas med t.ex. peeling eller laser (läs mer i vår <Link href="/blogg/pigmentflackar" className="text-primary hover:underline">guide till pigmentfläckar</Link>).</li>
